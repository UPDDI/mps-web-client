// QUINN - Maximum value for adjusting color thresholds.
var qMaxValue;
var qAvgValue;
...
/***/ (function(module, exports) {
	...
	module.exports = function set_defaults() {
	  ...
	  var defaults = {
	    ...
	    // matrix options
	    transpose: false,
        // QUINN - TODO explore where this is used. Where does blue emerge if 0 values are typically just red with 0 opacity..?
	...
	module.exports = function make_simple_rows(params, inst_data, tip, row_selection, ds_level = -1) {
	  ...
	  var tile = d3.select(row_selection).selectAll('rect').data(row_values, function (d) {
	    ...
	    if (d.value_orig === 'NaN') {
          ...
          // QUINN - Adjusting code to support three colors.
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function make_colorbar(cgm) {
	  ...
	  if (min_link >= 0) {
        ...
        // QUINN - Modifications here to produce the three-color gradient that was requested.
